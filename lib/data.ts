...
export const projectsData = [
  {
    ...
    description:
      "I have this project made with React,but I've decided to convert it to Next.js version as well. I couldn't figure out how to persist state with Next.js. React version had no issues with it.",
